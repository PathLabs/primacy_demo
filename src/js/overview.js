...
for (element in result){
  ...
  f_homopolymers_percent.innerHTML = result[element]['forward'][primer_id]['homopolymers']['percent'];
  f_homopolymers_run.innerHTML= result[element]['forward'][primer_id]['homopolymers']['run'];
  f_dimerization_percent.innerHTML = result[element]['forward'][primer_id]['dimerization']['percent'];
  f_dimerization_run.innerHTML= result[element]['forward'][primer_id]['dimerization']['run'];
  f_dimerization_median.innerHTML = result[element]['forward'][primer_id]['dimerization']['median'];
  f_dimerization_hairpin.innerHTML= result[element]['forward'][primer_id]['dimerization']['hairpin'];
  ...
  r_homopolymers_percent.innerHTML = result[element]['reverse'][primer_id]['homopolymers']['percent'];
  r_homopolymers_run.innerHTML= result[element]['reverse'][primer_id]['homopolymers']['run'];
  r_dimerization_percent.innerHTML = result[element]['reverse'][primer_id]['dimerization']['percent'];
  r_dimerization_run.innerHTML= result[element]['reverse'][primer_id]['dimerization']['run'];
  r_dimerization_median.innerHTML = result[element]['reverse'][primer_id]['dimerization']['median'];
  r_dimerization_hairpin.innerHTML= result[element]['reverse'][primer_id]['dimerization']['hairpin'];
